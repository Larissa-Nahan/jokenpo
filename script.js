...
$rockButtonP1.addEventListener("click", function () {
  $fieldPlayer1.innerHTML = '<img src="./rock.png" alt="Mão fechada" class="move-image">';
});
$paperButtonP1.addEventListener("click", function () {
  $fieldPlayer1.innerHTML = '<img src="./paper.png" alt="Mão aberta" class="move-image">';
});
$scissorsButtonP1.addEventListener("click", function () {
  $fieldPlayer1.innerHTML = '<img src="./scissors.png" alt="Mão fechada com os dedos indicador e médio levantados" class="move-image">';
});

$rockButtonP2.addEventListener("click", function () {
  $fieldPlayer2.innerHTML = '<img src="./rock.png" alt="Mão fechada" class="move-image">';
});
$paperButtonP2.addEventListener("click", function () {
  $fieldPlayer2.innerHTML = '<img src="./paper.png" alt="Mão aberta" class="move-image">';
});
$scissorsButtonP2.addEventListener("click", function () {
  $fieldPlayer2.innerHTML = '<img src="./scissors.png" alt="Mão fechada com os dedos indicador e médio levantados" class="move-image">';
});
